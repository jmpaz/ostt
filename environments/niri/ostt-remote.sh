...
if [ -n "${OSTT_TRANSCRIPTION_ENDPOINT:-}" ]; then
    export OPENAI_TRANSCRIPTION_URL="${OSTT_TRANSCRIPTION_ENDPOINT}"
fi

if [ -n "${OSTT_TRANSCRIPTION_MODEL:-}" ]; then
    export OPENAI_TRANSCRIPTION_MODEL="${OSTT_TRANSCRIPTION_MODEL}"
fi

if [ -n "${OSTT_TRANSCRIPTION_API_KEY:-}" ]; then
    export OPENAI_TRANSCRIPTION_API_KEY="${OSTT_TRANSCRIPTION_API_KEY}"
fi
